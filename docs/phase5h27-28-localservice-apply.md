# Phase 5h.27 / 5h.28: retained-handle live collector + LocalService first-install apply

Phase 5h.27 retains an `OpenService` handle through `DeleteService` (via
...
Phase 5h.28 compiles a vault-free first-install apply under the helper module
