...
export function buildMacosLaunchdBoundaryPlan(input) {
  ...
  const plan = deepFreeze({
    ...
    ipc: {
      transport: 'macos_mach_message_service',
      mach_service_name: MACH_SERVICE,
      mach_service_bound_by_launchd_required: true,
      anonymous_listener_forbidden: true,
      mach_audit_trailer_required: true,
      complex_messages_forbidden: true,
      send_once_reply_port_required: true,
    ...
    approval_gates: [
      ...
      'mach_peer_caller_binding_reverified',
